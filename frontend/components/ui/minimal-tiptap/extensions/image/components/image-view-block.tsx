...
export const ImageViewBlock: React.FC<NodeViewProps> = ({
  ...
  const containerRect = useContainerSize(containerElement)
  ...
  const containerMaxWidth = containerRect.width || Infinity
  ...
  const visibleResizeHandle = isResizing ? activeResizeHandle : null
        ...
        >
          <div className="h-full contain-paint">
            <div className="relative h-full">
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element -- Tiptap node views need direct img resize handles. */}
                <img
                  className={cn(
              ...
              !imageState.isServerUploading && (
                <>
                  <ResizeHandle
                    ...
                    className={cn("left-1", {
                      hidden: isResizing && visibleResizeHandle === "right",
                    })}
                    isResizing={isResizing && visibleResizeHandle === "left"}
                  />
                  <ResizeHandle
                    onPointerDown={handleResizeStart("right")}
                    className={cn("right-1", {
                      hidden: isResizing && visibleResizeHandle === "left",
                    })}
                    isResizing={isResizing && visibleResizeHandle === "right"}
                  />
                </>
              )}
          </div>
