...
- `implementation-skills.md`: when to load specialized skills for each roadmap phase.
- `local-dev.md`: host ports, env files, and common local commands.
- `TRACE_SPEC.md`: trace tiers, friction capture, and deduplication rules.
